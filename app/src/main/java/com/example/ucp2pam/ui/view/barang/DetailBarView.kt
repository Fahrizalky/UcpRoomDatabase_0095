...
import com.example.ucp2pam.ui.viewmodel.DetailBarViewModel
import com.example.ucp2pam.ui.viewmodel.DetailUiState
import com.example.ucp2pam.ui.viewmodel.PenyediaViewModel
import com.example.ucp2pam.ui.viewmodel.toBarangEntity
...
fun DetailBarView(
    ...
    viewModel: DetailBarViewModel = viewModel(factory = PenyediaViewModel.Factory),
    onBack: () -> Unit = {},
...
fun ItemDetailBar(
    ...
    Card(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.padding(4.dp))
            ComponentDetailBar(judul = "Nama Suplier", isinya = barang.namaSuplier)
            Spacer(modifier = Modifier.padding(4.dp))
